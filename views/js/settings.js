jQuery(document).ready(function() {
	...
	jQuery("#addSlide").click(function() {
		jQuery(".slideGroup:last").after(
			"<tbody class=\"slideGroup\"><tr><td><h2>New Slide</h2></td></tr><tr><td><label for=\"carousel_image_array\">Image Url</label></td><td><input class=\"newSlide" + slideCount + "\" name=\"carousel_image_array[]\" type=\"text\"><input class=\"upload_image_button button\" id=\"newSlide" + slideCount + "\" type=\"button\" value=\"Upload Image\" /></td></tr><tr><td><label for=\"carousel_icon_array\">Icon Url</label></td><td><input class=\"icon" + slideCount + "\" name=\"carousel_icon_array[]\" type=\"text\"><input class=\"upload_image_button button\" id=\"icon" + slideCount + "\" type=\"button\" value=\"Upload Image\" /></td></tr><tr><td><label for=\"carousel_message_array\">Caption</label></td><td><input name=\"carousel_message_array[]\" type=\"text\"></td></tr><tr><td><label for=\"carousel_link_array\">Link</label></td><td><input name=\"carousel_link_array[]\" type=\"text\"></td></tr><tr class=\"deleteSlide\"><td><a class=\"button button-primary\">Delete This Slide</a></td></tr></tbody>"
		);
		slideCount++;
